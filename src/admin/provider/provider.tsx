    ...
    return (
      <div>
        <h2 id="provider-heading">
          <Translate contentKey="travelwebApp.provider.home.title">Providers</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="travelwebApp.provider.home.createLabel">Create new Provider</Translate>
          </Link>
        </h2>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="travelwebApp.provider.name">Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
