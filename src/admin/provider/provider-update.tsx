    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="travelwebApp.provider.home.createOrEditLabel">
              <Translate contentKey="travelwebApp.provider.home.createOrEditLabel">Create or edit a Provider</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
