    ...
    return (
      <div>
        <h2 id="vehicle-type-heading">
          <Translate contentKey="travelwebApp.vehicleType.home.title">Vehicle Types</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="travelwebApp.vehicleType.home.createLabel">Create new Vehicle Type</Translate>
          </Link>
        </h2>
