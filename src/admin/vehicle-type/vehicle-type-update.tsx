...
export class VehicleTypeUpdate extends React.Component<IVehicleTypeUpdateProps, IVehicleTypeUpdateState> {
  ...
  render() {
    const { vehicleTypeEntity, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="travelwebApp.vehicleType.home.createOrEditLabel">
              <Translate contentKey="travelwebApp.vehicleType.home.createOrEditLabel">Create or edit a VehicleType</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
