  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="travelwebApp.location.detail.title">Location</Translate> [<b>{locationEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            ...
            <dd>{locationEntity.providerName ? locationEntity.providerName : ''}</dd>
          </dl>
