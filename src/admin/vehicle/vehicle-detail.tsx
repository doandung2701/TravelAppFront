  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="travelwebApp.vehicle.detail.title">Vehicle</Translate> [<b>{vehicleEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            ...
            <dd>{vehicleEntity.container}</dd>
            <dt>
              <Translate contentKey="travelwebApp.vehicle.vehicleType">Vehicle Type</Translate>
            </dt>
            <dd>{vehicleEntity.vehicleTypeName ? vehicleEntity.vehicleTypeName : ''}</dd>
          </dl>
