    ...
    return (
      <div>
        <h2 id="ticket-heading">
          <Translate contentKey="travelwebApp.ticket.home.title">Tickets</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="travelwebApp.ticket.home.createLabel">Create new Ticket</Translate>
          </Link>
        </h2>
