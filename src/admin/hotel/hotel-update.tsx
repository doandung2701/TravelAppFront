...
export class HotelUpdate extends React.Component<IHotelUpdateProps, IHotelUpdateState> {
  ...
  render() {
    const { hotelEntity, providers, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="travelwebApp.hotel.home.createOrEditLabel">
              <Translate contentKey="travelwebApp.hotel.home.createOrEditLabel">Create or edit a Hotel</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : hotelEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="nameLabel" for="name">
                    <Translate contentKey="travelwebApp.hotel.name">Name</Translate>
                  </Label>
                  <AvField
                    id="hotel-name"
                    type="text"
                ...
                <AvGroup>
                  <Label id="addressLabel" for="address">
                    <Translate contentKey="travelwebApp.hotel.address">Address</Translate>
                  </Label>
                  <AvField
                    id="hotel-address"
                    type="text"
                ...
                <AvGroup>
                  <Label id="phoneLabel" for="phone">
                    <Translate contentKey="travelwebApp.hotel.phone">Phone</Translate>
                  </Label>
                  <AvField
                    id="hotel-phone"
                    type="text"
                ...
                <AvGroup>
                  <Label for="provider.name">
                    <Translate contentKey="travelwebApp.hotel.provider">Provider</Translate>
                  </Label>
                  <AvInput id="hotel-provider" type="select" className="form-control" name="providerId">
                    <option value="" key="0" />
                    {providers
